...
namespace DB
{
    ...
    public:
        ...
        PersistentTrie(std::string name, std::string ownername)
            : totalNodes{0}, currentRoot{make_shared<TrieNode>(totalNodes)}, m_name{name}, m_ownerName{ownername}
        {}
        ...
        ~PersistentTrie(){
            ...
            std::cout << "Saved Database: " << m_name << " for User: " << m_ownerName << std::endl;
